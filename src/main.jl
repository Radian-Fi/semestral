...
function update_visualization_parameters(bound, field, limits)
    ...
    return flow_field, boundx, boundy, boundz, arrow_size, volumecolormap, volumedata
end;
...
function main()
    ...
    bound = [Observable((-4.:4., -4.:4., -4.:4.)) for _ in 1:2]
    ...
    on(minmaxnorm[1]) do n
        println("el. minmaxnorm updated")
    end
